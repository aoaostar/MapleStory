...
var 宗师级附魔师 = "#fEffect/SkillName1.img/1001003/宗师级附魔师#";
var status = 0;
var 黑水晶 = 4021008;
...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (mode == 1)
            ...
            status--;
        if (status == 0) {
	    var a1 = "#L1##b力量附魔 + 10#l  #L5##b命中附魔 + 10#l  #L9##b物击附魔 + 8#l\r\n";
		var a2 = "#L2##b敏捷附魔 + 10#l  #L6##b回避附魔 + 10#l  #L10##b魔攻附魔 + 8#l\r\n";
		var a3 = "#L3##b智力附魔 + 10#l  #L7##b生命附魔 + 100#l #L11##b次数附魔 + 1#l\r\n";
		var a4 = "#L4##b运气附魔 + 10#l  #L8##b魔力附魔 + 100#l \r\n";


           cm.sendSimple(""+ 宗师级附魔师+"  \r\n#r       - 需要附魔的装备放在第一行第一格 -#k\r\n\r\n"+a1+""+a2+""+a3+""+a4+"");
	    } else if (selection == 1) {
