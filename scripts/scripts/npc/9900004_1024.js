...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
			...
			text += ""+蓝色角点+""+蓝色角点+""+蓝色角点+""+蓝色角点+""+蓝色角点+""+蓝色角点+""+蓝色角点+""+蓝色角点+""+蓝色角点+""+蓝色角点+""+蓝色角点+""+蓝色角点+""+蓝色角点+""+蓝色角点+""+蓝色角点+""+蓝色角点+""+蓝色角点+""+蓝色角点+""+蓝色角点+""+蓝色角点+""+蓝色角点+""+蓝色角点+""+蓝色角点+""+蓝色角点+""+蓝色角点+""
			text += "#L1##b#v2044700##z2044700#      #r5充值币/1个 #l\r\n"
			text += "#L2##b#v2043300##z2043300#      #r5充值币/1个 #l\r\n"
			text += "#L3##b#v2044400##z2044400#      #r5充值币/1个 #l\r\n"
			text += "#L4##b#v2044300##z2044300#      #r5充值币/1个 #l\r\n"
			text += "#L5##b#v2044200##z2044200#      #r5充值币/1个 #l\r\n"
			text += "#L6##b#v2044100##z2044100#      #r5充值币/1个 #l\r\n"
			text += "#L7##b#v2044000##z2044000#      #r5充值币/1个 #l\r\n"
			text += "#L8##b#v2043200##z2043200#      #r5充值币/1个 #l\r\n"
			text += "#L9##b#v2043100##z2043100#      #r5充值币/1个 #l\r\n"
			text += "#L10##b#v2043000##z2043000#      #r5充值币/1个 #l\r\n"
			text += "#L11##b#v2044500##z2044500#      #r5充值币/1个 #l\r\n"
			text += "#L12##b#v2044600##z2044600#      #r5充值币/1个 #l\r\n"
			text += "#L13##b#v2044800##z2044800#      #r5充值币/1个 #l\r\n"
			text += "#L14##b#v2044900##z2044900#      #r5充值币/1个 #l\r\n"
...
cm.全服漂浮喇叭("恭喜玩家["+cm.getName()+"]成功购买M拳套攻击卷轴一张~!", 5121005);
				cm.dispose();
			} else {
...
cm.全服漂浮喇叭("恭喜玩家["+cm.getName()+"]成功购买M短剑攻击卷一张~!", 5121005);
				cm.dispose();
			} else {
				cm.sendOk("您的充值币不足~!请充值！");
            cm.dispose();
