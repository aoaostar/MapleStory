...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
			...
			text += ""+蓝色角点+""+蓝色角点+""+蓝色角点+""+蓝色角点+""+蓝色角点+""+蓝色角点+""+蓝色角点+""+蓝色角点+""+蓝色角点+""+蓝色角点+""+蓝色角点+""+蓝色角点+""+蓝色角点+""+蓝色角点+""+蓝色角点+""+蓝色角点+""+蓝色角点+""+蓝色角点+""+蓝色角点+""+蓝色角点+""+蓝色角点+""+蓝色角点+""+蓝色角点+""+蓝色角点+""+蓝色角点+""
			text += "#L1##b#v2040917##z2040917#      #r5充值币/1个 #l\r\n"
			text += "#L2##b#v2041232##z2041232#      #r5充值币/1个 #l\r\n"
			text += "#L3##b#v2040822##z2040822#      #r5充值币/1个 #l\r\n"
			text += "#L4##b#v2040300##z2040300#      #r5充值币/1个 #l\r\n"
...
cm.全服漂浮喇叭("恭喜玩家["+cm.getName()+"]成功购买M盾牌攻击卷轴一张~!", 5121005);
				cm.dispose();
			} else {
            ...
            cm.dispose();
				...
				if(cm.getmoneyb() >= 5){
					cm.setmoneyb(-5);
			 cm.gainItem(2041232,1);

cm.全服漂浮喇叭("恭喜玩家["+cm.getName()+"]成功购买M项链攻击卷一张~!", 5121005);
				cm.dispose();
			} else {
				cm.sendOk("您的充值币不足~!请充值！");
            cm.dispose();
...
cm.全服漂浮喇叭("恭喜玩家["+cm.getName()+"]成功购买M手套攻击卷一张~!", 5121007);
				cm.dispose();
			} else {
				cm.sendOk("您的充值币不足~!请充值！");
            cm.dispose();
				...
				if(cm.getmoneyb() >= 5){
					cm.setmoneyb(-5);
			 cm.gainItem(2040300,1);			
cm.全服漂浮喇叭("恭喜玩家["+cm.getName()+"]成功购买M耳环攻击卷一张~!", 5121007);
				cm.dispose();
			} else {
				cm.sendOk("您的充值币不足~!请充值！");
            cm.dispose();
