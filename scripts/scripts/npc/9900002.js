...
function action(mode, type, selection) {
    ...
    cm.teachSkill(5221010,0,5);
            ...
            //cm.sendSimple("怎么样~~在下面选择一种你所喜欢的职业吧！#b\r\n#L0#战士#l #L1#魔法师#l #L2#弓箭手#l #L3#飞侠#l #L4#海盗#l\r\n#L6#魂骑士#l #L7#炎术士#l #L8#风灵使者#l #L9#夜行者#l #L10#奇袭者#l\r\n#L5#战神#l");
            cm.sendSimple("怎么样~~在下面选择一种你所喜欢的职业吧！#b\r\n#L0#战士#l #L1#魔法师#l #L2#弓箭手#l #L3#飞侠#l #L4#海盗#l\r\n");
            ...
            if(cm.getJob() == 2000 && cm.getLevel() >=10){
                ...
                cm.serverNotice("[转职系统]: 恭喜 [" + cm.getPlayer().getName() + "] 在NPC：管理员 快速完成战神2次转职！");
               ...
               // cm.teachSkill(21120010,0,0); //战神之舞
                cm.serverNotice("[转职系统]: 恭喜 [" + cm.getPlayer().getName() + "] 在NPC：管理员 快速完成战神3次转职！");
               ...
               // cm.teachSkill(21120010,0,0); //战神之舞
                ...
                cm.changeJob(2112);
                cm.serverNotice("[转职系统]: 恭喜 [" + cm.getPlayer().getName() + "] 在NPC：管理员 快速完成战神4次转职！");
