    ...
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            text += ""+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+"\r\n\r\n"
                        text += "\t\t\t  #e转生系统#b（250级可转生） #k!#n\r\n\r\n#r\t\t\t\t转生后等会降低为200级\r\n\r\n\r\n"
            text += "       "+ 蓝色箭头 +"#L21##r需要国庆币#v4000463#X10+转生水晶#v4251402#X1+金币3E#l\r\n\r\n\r\n"//3
            text += ""+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+"\r\n"
        ...
        //    text += "" + 蓝色箭头 +"#L17##rLv70.鱼王皮亚奴斯洞穴#l\r\n\r\n"//3
         //   text += "" + 蓝色箭头 +"#L18##rLv70.时间塔的本源闹钟#l\r\n\r\n"//3
         //   text += "" + 蓝色箭头 + "#L19##rLv70.扎昆的祭坛挑战#l\r\n\r\n"//3
         //   text += "" + 蓝色箭头 + "#L20##rLv70.暗黑龙王的巢穴挑战#l\r\n\r\n"//3
         //   text += ""+星星+星星+星星+星星+星星+星星+星星+星星+星星+星星+星星+星星+星星+星星+星星+星星+星星+星星+星星+"\r\n"
            cm.sendSimple(text);
            ...
            if (cm.getLevel() < 70 ) {  
            cm.sendOk("本地图限制等级70级。您的能力没有资格挑战鱼王副本");
                cm.dispose();
              }else{
			cm.warp(230040420); 
            ...
            if (cm.getLevel() < 70 ) {  
            cm.sendOk("本地图限制等级70级。您的能力没有资格闹钟副本");
                cm.dispose();
              }else{
			cm.warp(220080000);  
            ...
            if (cm.getLevel() < 70 ) {  
            cm.sendOk("本地图限制等级70级。您的能力没有资格扎昆副本");
                cm.dispose();
              }else{
			cm.warp(211042400);
            ...
            if (cm.getLevel() < 70 ) {  
            cm.sendOk("本地图限制等级70级。您的能力没有资格暗黑龙王副本");
                cm.dispose();
              }else{
			cm.warp(240050400); 
cm.喇叭(1, "[BOSS传送]：玩家" + cm.getPlayer().getName() + "开始挑战暗黑龙王，大家祝福他能活着出来吧~");			
        ...
        } else if (selection == 21) {//转生
            if (cm.getLevel() < 250) {  
            cm.sendOk("转生限制等级250级。您的能力没有资格转生");
                cm.dispose();
				}else if(cm.getPlayer().getMeso() < 300000000){
	            cm.sendOk("需要3E才能转生.");
                cm.dispose();
				}else if(!cm.haveItem(4251402,1)){
				   cm.sendOk("需要转生水晶X1！");
                   cm.dispose();
				}else if(!cm.haveItem(4000463,10)){
				   cm.sendOk("需要国庆币X10！");
                   cm.dispose();
              }else{
	       cm.setPlayerStat("LVL",201)
           cm.gainItem(4000463,-10);		   
		   cm.gainItem(4251402,-1);
		   cm.gainMeso(-300000000);
		   cm.sendOk("恭喜！转生成功！请换线生效！.");
		 //  cm.changeJob(000)
			cm.喇叭(1, "[转生修仙]：玩家" + cm.getPlayer().getName() + "转生成功！可喜可贺！");				
				cm.dispose();
                return;
	      }
