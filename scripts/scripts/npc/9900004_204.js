...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            if (selection == 2) { 
			if(cm.getPlayer().getLevel() >29 && cm.getPlayer().getJob() == 300 ){
            ...
            cm.dispose();
			 ...
			 if (selection == 5) { 
			if(cm.getPlayer().getLevel() >69 && cm.getPlayer().getJob() == 310 ){
            ...
            cm.dispose();
			 ...
			 if (selection == 6) { 
			if(cm.getPlayer().getLevel() >69 && cm.getPlayer().getJob() == 320 ){
            ...
            cm.dispose();
			 ...
			 if (selection == 8) { 
			if(cm.getPlayer().getLevel() >119 && cm.getPlayer().getJob() == 311 ){
            ...
            cm.dispose();
			 ...
			 if (selection == 9) { 
			if(cm.getPlayer().getLevel() >119 && cm.getPlayer().getJob() == 321 ){
