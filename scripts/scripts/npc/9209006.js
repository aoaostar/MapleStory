...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            text += "#e#d你好!我是乌鸦羽毛帽商人!#v3994094#买入价格为#r200万#d冒险币.\r\n本周的卖出价格为#r200万#d冒险币。价格有浮动，入市需谨慎！嘿嘿！\r\n"//3
            text += "#L1##e#k#v4031975#我要买入#v3994094##l\r\n"//3
            text += "#L2##e#k#v4031975#我要卖出#v3994094##l\r\n"//3
		...
		cm.openNpc(9209006, 1);
        } else if (selection == 2) {
		cm.openNpc(9209006, 2);
        } else if (selection == 3) {
