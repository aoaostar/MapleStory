    ...
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            if (cm.haveItem(2022336, 1)) {//二次判断是否存在神秘箱子（新手礼包箱子）
				...
				cm.gainItem(1052550,10,10,10,10,10,10,10,10,10,10,10,10,10,10); //海豹上衣
				cm.gainItem(1003713,10,10,10,10,10,10,10,10,10,10,10,10,10,10); //海豹手套
				cm.gainItem(1082493,10,10,10,10,10,10,10,10,10,10,10,10,10,10); //海豹帽子
			...
			//	cm.gainItem(1302252,0,0,0,0,0,0,100,100,0,0,0,0,0,0,72); //新手武器
				...
				cm.gainItem(1142358,10,10,10,10,100,100,10,10,10,10,10,10,10,10); //新手勋章我最可爱
