...
function action(mode, type, selection) {   
		...
		if (status == 0) {
			...
			text += "服务器当前时间：#r" + hour +"点" + minute + "分" + second + "秒#n#k\r\n\r\n";
			...
			if(selection==2){
				if((minute >= 10 && minute <= 14)){
					...
					if(randx = 0){
						...
						tknow = itemtk1[randy];
						cm.sendGetNumber(Qicon + "#b问题：" + tknow[0] + "\r\n#r============================================#n#k\r\n#d答案1:"+tknow[1]+"\r\n答案2:"+tknow[2]+"\r\n答案3:"+tknow[3]+"\r\n答案4:"+tknow[4]+"\r\n============================================#n#k\r\n#r请输入你认为正确的答案,如果是答案1就填1，答案2就填2\r\n\r\n", 1, 1, 4);
