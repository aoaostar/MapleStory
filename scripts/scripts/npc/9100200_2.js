...
function action(mode, type, selection) {
    ...
    if (cm.getMapId() == 180000001) {
        ...
        var selStr = "  "+心+"  "+心+" "+心+" #e#r《"+MC+"娱乐赌博》#n#k  "+心+"  "+心+"  "+心+"\r\n\r\n";
		  ...
		  selStr += " "+粉问号+"赔率:#b"+粉问号赔率+"#k\r\n";

		  selStr += " "+粉斜号+"赔率:#b"+粉斜号赔率+"#k\r\n";	  
	
		  selStr += " "+粉小于号+"赔率:#b"+粉小于号赔率+"#k\r\n";	  
	
		  selStr += " "+粉大于号+"赔率:#b"+粉大于号赔率+"#k\r\n";	  

		  selStr += " "+粉感叹号+"赔率:#b"+粉感叹号赔率+"#k\r\n";


		  selStr += " "+粉艾特号+"赔率:#b"+粉艾特号赔率+"#k\r\n";	  

		  selStr += " "+粉点号+"赔率:#b"+粉点号赔率+"#k\r\n";

		  selStr += " "+粉笑眼号+"赔率:#b"+粉笑眼号赔率+"#k\r\n";	  

		  selStr += " "+粉爱心号+"赔率:#b"+粉爱心号赔率+"#k\r\n";	  

		  selStr += " "+粉五角星号+"赔率:#b"+粉五角星号赔率+"#k\r\n";	  
