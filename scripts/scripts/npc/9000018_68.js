...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            text += "#e#d制作#v1452057#需要#v4011007#x10.#v4021009#x10.#v4005002#x20.#v4005004#x20.#v4031891#1000万.搜集好道具我就可以为您制作了.#l\r\n\r\n"//3
            text += "#L1##r制作永恒武器#l\r\n\r\n"//3
            cm.sendSimple(text);
        } else if (selection == 1) {
			//1
            ...
            cm.sendOk("制作成功！");
			cm.worldMessage(6,"玩家：["+cm.getName()+"]制作了[永恒惊电弓]，带上你的武器去狩猎吧！");
            cm.dispose();
			}else{
            cm.sendOk("您的材料不足！");
            cm.dispose();
