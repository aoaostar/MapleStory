...
var maps = Array(
        Array(500000000, 3000, 2900), //泰国(水上市场)
        Array(702000000, 3000, 2900), //东方神州(嵩山少林)
        Array(800000000, 3000, 2900), //江户村(古代神社)
        Array(701000000, 3000, 2900), //东方神州(上海外滩)
        Array(550000000, 3000, 2900), //马来西亚(吉隆大都市)
        Array(540000000, 3000, 2900)//新加坡(中心商务区)
        );
