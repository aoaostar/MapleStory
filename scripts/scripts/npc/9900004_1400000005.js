...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
			...
			if (cm.haveItem(1032209, 1)&&cm.haveItem(4030002, 10)&&cm.haveItem(4030003, 10)&&cm.haveItem(4030004, 10)&&cm.haveItem(4030005, 10)&&cm.haveItem(4030006, 10)&&cm.haveItem(4030007, 10)&&cm.haveItem(4030008, 10)&& cm.getMeso() > 15000000&&!cm.getInventory(1).isFull()) {
				cm.gainItem(1032209, -1);
				cm.gainItem(4030002, -10);
				cm.gainItem(4030003, -10);
				cm.gainItem(4030004, -10);
				cm.gainItem(4030005, -10);
				cm.gainItem(4030006, -10);
