...
function action(mode, type, selection) {
	if (mode == -1) {
		...
		if (status == 0) {
			...
			cm.sendSimple("\t\t\t\t\t#e#r欢迎来到点券换购系统中心#n\r\n#d====================================================\r\n#d目前账户剩余点券:"+ cm.getPlayer().getNX() + "\r\n====================================================#b#n\r\n#L2##b#e兑换10万经验 需要点券3千#v2022450##b#n\r\n#L3##b#e兑换20万经验 需要点券5千#v2022451##b#n\r\n#L4##b#e兑换30万经验 需要点券7千#v2022452#\r\n");
			} else if (status == 1) {
                  if (selection == 1) {
		  cm.sendOk("\t\t\t#e#b点券的获取方法（新人必看）#n#d\r\n====================================================#k\r\n本服一切装备都可以靠努力获得，加油！#k#d\r\n====================================================#k\r\n想要获得更多信息咨询，请加入我们的交流群一起讨论#r#d\r\n");
	          cm.dispose();
                ...
                cm.sendOk("#b#e恭喜您获得#r#e【10万经验值，加油哦】");
				cm.gainExp([100000]);
                cm.gainNX(-3000);
                cm.喇叭(3,"恭喜玩家[" + cm.getChar().getName() + "]兑换10万经验值成功！！");
                cm.dispose();		
                }else{ 
                ...
                cm.sendOk("#b#e恭喜您获得#r#e【20万经验值，加油哦】.");
                cm.gainExp([200000]);
                cm.gainNX(-5000);
                cm.喇叭(3,"恭喜玩家[" + cm.getChar().getName() + "]兑换20万经验值成功！！");
                cm.dispose();		
                }else{ 
                ...
                cm.sendOk("#b#e恭喜您获得#r#e【30万经验值，加油哦】.");
                cm.gainExp([300000]);
                cm.gainNX(-7000);
                cm.喇叭(3,"恭喜玩家[" + cm.getChar().getName() + "]兑换30万经验值成功！！");
                cm.dispose();		
                }else{ 
                cm.sendOk("#b您没有足够的点券进行购买,请努力收集吧.");
                cm.dispose();
