...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
          ...
          //  text += "#L3##r制作#v1132246# 需要：#v1132243#X1 #v1132244#X1 #v1132245#X1 #l\r\n"//3
			//text += "#L4##r制作#v1113075# 需要：#v1113072#X1 #v1113073#X1 #v1113074#X1 #l\r\n"//3
			//text += "#L5##r制作#v1032223# 需要：#v1032220#X1 #v1032221#X1 #v1032222#X1 #l\r\n"//3
			//text += "#L6##r制作#v1112593# 需要：#v1112444#X1 #v1112915#X1 #l\r\n"//3
			//text += "#L7##r制作#v1113048# 需要：#v1112593#X4 #v1113020#X1 5亿游戏币#l\r\n"//3
			//text += "#L8##r制作#v1113012# 需要：#v1112951#X1 #v1112952#X1 #l\r\n"//3
		    //text += "#L9##r制作#v1113089# 需要：#v1112763#X1 #v1112775#X1 #v1112771#X1 #v1112767#X1#l\r\n"//3
			text += "#L10##r制作#v1052669##v1102623##v1082556##v1072870#\r\n 需要：#v1032206#X1 #v1032207#X1 #v1032208#X1 #v1032209#X1#l\r\n"//3
			text += "#L11##r制作#v1032205# 需要：#v1032219#X1 #v4000464#X1 5亿游戏币 5W点券#l\r\n"//3
			text += "#L12##r制作#v1012174# 需要：#v1012170#X1 #v1012171#X1 #v1012172#X1 #v1012172#X1#l\r\n"//3
			text += "#L13##r制作#v1132215# 需要：#v1132211#X1 #v1132212#X1 #v1132213#X1 #v1132214#X1#l\r\n"//3
            cm.sendSimple(text);
        } else if (selection == 1) {
			...
			if (cm.itemQuantity(1113072) < 1 ) { 
				cm.sendOk("#b装备合成需要#v1132036#，您的物品不足#k");
				cm.dispose();
			} else if (cm.itemQuantity(1113073) < 1 ) { 
				cm.sendOk("#b装备合成需要#v1132037#，您的物品不足#k");
				cm.dispose();
				} else if (cm.itemQuantity(1113074) < 1 ) { 
				cm.sendOk("#b装备合成需要#v1132038#，您的物品不足#k");
				cm.dispose();
			...
			if (cm.itemQuantity(1112951) < 1 ) { 
				...
				cm.gainItem(1113012, 66,66,66,66,100,100,66,66,0,0,0,0,0,0);
            cm.sendOk("制作成功！");
