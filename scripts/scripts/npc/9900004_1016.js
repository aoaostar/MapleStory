...
function action(mode, type, selection) {
	if (mode == -1) {
		...
		if (status == 0) {
			...
			cm.sendSimple("\t\t\t\t\t#e#r欢迎来到点券换购系统中心#n\r\n#d====================================================\r\n#d目前账户剩余点券:"+ cm.getPlayer().getNX() + "\r\n====================================================#b#n\r\n#L2##b#e兑换金色枫叶20个  需要点券2千#v4000313##b#n\r\n#L3##b#e兑换金色枫叶40个  需要点券3千#v4000313##b#n\r\n");
			} else if (status == 1) {
                  if (selection == 1) {
		  cm.sendOk("\t\t\t#e#b点券的获取方法（新人必看）#n#d\r\n====================================================#k\r\n本服一切装备都可以靠努力获得，加油！#k#d\r\n====================================================#k\r\n想要获得更多信息咨询，请加入我们的交流群一起讨论#r#d\r\n");
	          cm.dispose();
                ...
                cm.sendOk("#b#e恭喜您获得#r#e【金色枫叶20个】");
                cm.gainItem(4000313,20);
                cm.gainNX(-2000);
                cm.喇叭(3,"恭喜玩家[" + cm.getChar().getName() + "]兑换金色枫叶20个成功！！");
                cm.dispose();		
                }else{ 
                ...
                cm.sendOk("#b#e恭喜您获得#r#e【金色枫叶40个】.");
                cm.gainItem(4000313,40);
                cm.gainNX(-3000);
                cm.喇叭(3,"恭喜玩家[" + cm.getChar().getName() + "]兑换金色枫叶40个成功！！");
                cm.dispose();		
                }else{ 
