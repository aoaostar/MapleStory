...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            text += "" + 蓝色箭头 + "#L2##r制作#v1122135##z1122135#\r\n需要：#v4001126# 800个、#v1122129# 1个、金币=500W\r\n\r\n"//3
            text += "" + 蓝色箭头 + "#L3##r制作#v1122140##z1122140#\r\n需要：#v4001126# 2000个、#v1122135# 1个、金币=1000W、#v4005002# 15个\r\n\r\n"//3
            text += "" + 蓝色箭头 + "#L4##r制作#v1122145##z1122145#\r\n需要：#v4001126# 3000个、#v1122140# 1个、金币=2500W、#v4005002# 25个\r\n\r\n"//3
            text += "" + 蓝色箭头 + "#L5##r制作#v1122124##z1122124#\r\n需要：#v4001126# 5000个、#v1122145# 1个、金币=5000W、#v4005002# 50个\r\n\r\n"//3
...
cm.喇叭(2, "[" + cm.getPlayer().getName() + "]成功制作[封印冒险之心-弓手专属]，完成了变强的第二步！");
            cm.dispose();
			}else{
            cm.sendOk("道具不足无法换购！");
            cm.dispose();
			...
			if(cm.haveItem(4001126,2000) && cm.haveItem(1122135,1) && cm.haveItem(4005002,15) && cm.getMeso() >= 10000000){
				cm.gainItem(4001126, -2000);
				cm.gainItem(1122135, -1);
				cm.gainItem(4005002, -15);
				cm.gainMeso(-10000000);
				cm.gainItem(1122140, 1);
cm.喇叭(2, "[" + cm.getPlayer().getName() + "]成功制作[苏醒冒险之心-弓手专属]，完成了变强的第三步！");
            cm.dispose();
			}else{
            cm.sendOk("道具不足无法换购！");
            cm.dispose();
			...
			if(cm.haveItem(4001126,3000) && cm.haveItem(1122140,1) && cm.haveItem(4005002,25) && cm.getMeso() >= 25000000){
				cm.gainItem(4001126, -3000);
				cm.gainItem(1122140, -1);
				cm.gainItem(4005002, -25);
				cm.gainMeso(-25000000);
				cm.gainItem(1122145, 1);
cm.喇叭(2, "[" + cm.getPlayer().getName() + "]成功制作[觉醒冒险之心-弓手专属]，完成了变强的第四步！");
            cm.dispose();
			}else{
            cm.sendOk("道具不足无法换购！");
            cm.dispose();
			...
			if(cm.haveItem(4001126,5000) && cm.haveItem(1122145,1) && cm.haveItem(4005002,50) && cm.getMeso() >= 50000000){
				cm.gainItem(4001126, -5000);
				cm.gainItem(1122145, -1);
				cm.gainItem(4005002, -50);
				cm.gainMeso(-50000000);
				cm.gainItem(1122124, 1);
cm.喇叭(2, "[" + cm.getPlayer().getName() + "]成功制作[真觉醒冒险之心-弓手专属]，完成了变强的最后一步！");
            cm.dispose();
			}else{
            cm.sendOk("道具不足无法换购！");
            cm.dispose();
