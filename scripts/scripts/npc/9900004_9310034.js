...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
			...
			text += "#L102##d" + 蓝色箭头 + "雷卡副本#l    #L103##d" + 蓝色箭头 + "蓝蘑菇王副本#l\r\n\r\n"//3			
            text += ""+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+"\r\n"
		...
		} else if (selection == 103) {//蓝蘑菇王
            if (cm.getLevel() < 90 ) {  
            cm.sendOk("本地图限制等级90级。您的能力没有资格挑战蓝蘑菇王副本");
                cm.dispose();
              }else{
			cm.warp(800010100); 
			cm.喇叭(1, "[BOSS传送]：玩家" + cm.getPlayer().getName() + "开始挑战蓝蘑菇王副本，大家都来战个痛快吧~");			
				cm.dispose();
                return;
	      }   
