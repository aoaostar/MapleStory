...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        var text="请选择您要兑换的装备:\r\n";
		text+="#b#L4##v4000487#x10 + #v4000017#x10兑换 #v1082002#(四维+5)#l\r\n";
		text+="#b#L5##v4000487#x10 + #v1082002#x1 + #v4000017#x20 兑换 #v1082219#(四维+10,攻魔+10)#l\r\n";
		text+="#b#L6##v4000487#x30 + #v1082002#x1 + #v1082219#x1 + #v4000017#x30 兑换 #v1082244#(四维+30,攻魔+30)#l\r\n";
		...
		if(selection==1){
			...
			cm.gainItem(1082002,5,5,5,5,0,0,5,5,0,0,0,0,0,0,0);
