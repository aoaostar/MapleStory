...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            text += "" + 蓝色箭头 + "#L2##r制作#v1122134##z1122134#\r\n需要：#v4001126# 800个、#v1122129# 1个、金币=500W\r\n\r\n"//3
            text += "" + 蓝色箭头 + "#L3##r制作#v1122139##z1122139#\r\n需要：#v4001126# 2000个、#v1122134# 1个、金币=1000W、#v4005001# 15个\r\n\r\n"//3
            text += "" + 蓝色箭头 + "#L4##r制作#v1122144##z1122144#\r\n需要：#v4001126# 3000个、#v1122139# 1个、金币=2500W、#v4005001# 25个\r\n\r\n"//3
            text += "" + 蓝色箭头 + "#L5##r制作#v1122123##z1122123#\r\n需要：#v4001126# 5000个、#v1122144# 1个、金币=5000W、#v4005001# 50个\r\n\r\n"//3
...
cm.喇叭(2, "[" + cm.getPlayer().getName() + "]成功制作[封印冒险之心-法师专属]，完成了变强的第二步！");
            cm.dispose();
			}else{
            cm.sendOk("道具不足无法换购！");
            cm.dispose();
...
cm.喇叭(2, "[" + cm.getPlayer().getName() + "]成功制作[苏醒冒险之心-法师专属]，完成了变强的第三步！");
            cm.dispose();
			}else{
            cm.sendOk("道具不足无法换购！");
            cm.dispose();
...
cm.喇叭(2, "[" + cm.getPlayer().getName() + "]成功制作[觉醒冒险之心-法师专属]，完成了变强的第四步！");
            cm.dispose();
			}else{
            cm.sendOk("道具不足无法换购！");
            cm.dispose();
...
cm.喇叭(2, "[" + cm.getPlayer().getName() + "]成功制作[真觉醒冒险之心-法师专属]，完成了变强的最后一步！");
            cm.dispose();
			}else{
            cm.sendOk("道具不足无法换购！");
            cm.dispose();
