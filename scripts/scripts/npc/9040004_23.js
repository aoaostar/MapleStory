...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (mode == 1)
            ...
            status--;
        if (status == 0) {
            var a1 = "#L1#" + 红色箭头 + " #b制作#v1102040# 需要#v1102041#*1+#v4002000#*50+#v4002001#*30+#v4000463#*50+#v4031456#*50+#v4170007#*10+金币500W#l\r\n\r\n";
            var a2 = "#L2#" + 红色箭头 + " #b制作#v1102042# 需要#v1102040#*1+#v4002000#*100+#v4002001#*50+#v4000463#*66+#v4031456#*100+#v4170007#*20+金币1000W#l\r\n\r\n";
            var a3 = "#L3#" + 红色箭头 + " #b制作#v1102043# 需要#v1102042#*1+#v4002000#*200+#v4002001#*80+#v4000463#*100+#v4031456#*200+#v4170007#*30+金币2000W#l\r\n\r\n";
	    ...
	    if (cm.getInventory(1).isFull()){
            ...
            if (selection == 1) {//红
				if(cm.haveItem(1102041,1) && cm.haveItem(4002000,50) && cm.haveItem(4002001,30) && cm.haveItem(4000463,50) && cm.haveItem(4031456,50) && cm.haveItem(4170007,10) && cm.getMeso() > 5000000){
				...
				cm.dispose();
					...
					if(cm.haveItem(1102040,1) && cm.haveItem(4002000,100) && cm.haveItem(4002001,50) && cm.haveItem(4000463,66) && cm.haveItem(4031456,100) && cm.haveItem(4170007,20) && cm.getMeso() > 10000000){
				...
				cm.dispose();
	              ...
	              if(cm.haveItem(1102042,1) && cm.haveItem(4002000,200) && cm.haveItem(4002001,80) && cm.haveItem(4000463,80) && cm.haveItem(4031456,200) && cm.haveItem(4170007,30) && cm.getMeso() > 20000000){
