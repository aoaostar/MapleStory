...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            text += "" + 蓝色箭头 + "#L2##r制作#v1122136##z1122136#\r\n需要：#v4001126# 800个、#v1122129# 1个、金币=500W\r\n\r\n"//3
            text += "" + 蓝色箭头 + "#L3##r制作#v1122141##z1122141#\r\n需要：#v4001126# 2000个、#v1122136# 1个、金币=1000W、#v4005003# 15个\r\n\r\n"//3
            text += "" + 蓝色箭头 + "#L4##r制作#v1122146##z1122146#\r\n需要：#v4001126# 3000个、#v1122141# 1个、金币=2500W、#v4005003# 25个\r\n\r\n"//3
            text += "" + 蓝色箭头 + "#L5##r制作#v1122125##z1122125#\r\n需要：#v4001126# 5000个、#v1122146# 1个、金币=5000W、#v4005003# 50个\r\n\r\n"//3
...
cm.喇叭(2, "[" + cm.getPlayer().getName() + "]成功制作[封印冒险之心-飞侠专属]，完成了变强的第二步！");
            cm.dispose();
			}else{
            cm.sendOk("道具不足无法换购！");
            cm.dispose();
			...
			if(cm.haveItem(4001126,2000) && cm.haveItem(1122136,1) && cm.haveItem(4005003,15) && cm.getMeso() >= 10000000){
				cm.gainItem(4001126, -2000);
				cm.gainItem(1122136, -1);
				cm.gainItem(4005003, -15);
				cm.gainMeso(-10000000);
				cm.gainItem(1122141, 1);
cm.喇叭(2, "[" + cm.getPlayer().getName() + "]成功制作[苏醒冒险之心-飞侠专属]，完成了变强的第三步！");
            cm.dispose();
			}else{
            cm.sendOk("道具不足无法换购！");
            cm.dispose();
			...
			if(cm.haveItem(4001126,3000) && cm.haveItem(1122141,1) && cm.haveItem(4005003,25) && cm.getMeso() >= 25000000){
				cm.gainItem(4001126, -3000);
				cm.gainItem(1122141, -1);
				cm.gainItem(4005003, -25);
				cm.gainMeso(-25000000);
				cm.gainItem(1122146, 1);
cm.喇叭(2, "[" + cm.getPlayer().getName() + "]成功制作[觉醒冒险之心-飞侠专属]，完成了变强的第四步！");
            cm.dispose();
			}else{
            cm.sendOk("道具不足无法换购！");
            cm.dispose();
			...
			if(cm.haveItem(4001126,5000) && cm.haveItem(1122146,1) && cm.haveItem(4005003,50) && cm.getMeso() >= 50000000){
				cm.gainItem(4001126, -5000);
				cm.gainItem(1122146, -1);
				cm.gainItem(4005003, -50);
				cm.gainMeso(-50000000);
				cm.gainItem(1122125, 1);
cm.喇叭(2, "[" + cm.getPlayer().getName() + "]成功制作[真觉醒冒险之心-飞侠专属]，完成了变强的最后一步！");
            cm.dispose();
			}else{
            cm.sendOk("道具不足无法换购！");
            cm.dispose();
