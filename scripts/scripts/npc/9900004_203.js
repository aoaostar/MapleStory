...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            if (selection == 2) { 
			if(cm.getPlayer().getLevel() >29 && cm.getPlayer().getJob() == 400 ){
            ...
            cm.dispose();
			 ...
			 if (selection == 5) { 
			if(cm.getPlayer().getLevel() >69 && cm.getPlayer().getJob() == 410 ){
            ...
            cm.dispose();
			 ...
			 if (selection == 6) { 
			if(cm.getPlayer().getLevel() >69 && cm.getPlayer().getJob() == 420 ){
            ...
            cm.dispose();
			 ...
			 if (selection == 8) { 
			if(cm.getPlayer().getLevel() >119 && cm.getPlayer().getJob() == 411 ){
            ...
            cm.dispose();
			 ...
			 if (selection == 9) { 
			if(cm.getPlayer().getLevel() >119 && cm.getPlayer().getJob() == 421 ){
