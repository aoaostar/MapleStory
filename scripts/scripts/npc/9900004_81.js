...
var status = 0;
  ...
  textz += "#L1#1.#v5570000##z5570000# 需要:#v4000235#30个 \r\n";
   textz += "#L2#2.#v5570000##z5570000# 需要:#v4000243#30个 \r\n";
 ...
 // textz += "#L14#10.#v2041139##z2041139# 需要:#v4005002#100个#v4001129#7个  \r\n";
  ...
  //textz += "#L17#8.#v1072853##z1072853# 需要:#v4251202#7个#v4001129#1个 \r\n";
		...
		cm.sendSimple (textz);  
	       ...
	       if (selection == 1){
                   if (!cm.haveItem(4000235,30)) {
 			cm.sendOk("请带来#v4000235##z4000235#*30");
			...
			cm.sendOk("#b兑换成功");
                  ...
                  if (!cm.haveItem(4000243,30)) {
    cm.sendOk("请带来#v4000243##z4000243#*30");
         cm.dispose();
