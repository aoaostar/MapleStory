...
function action(mode, type, selection) {
    ...
    //         var textz = "#r欢迎来到洗血中心!#k\r\n #k\r\n注意:装备请放第一格，#r洗血成功会全区报喜哦!#k\r\n";

    //         textz += "------------------------------------------------------\r\n";

    //         textz += "#b#L9#" + 红色 + "使用1000点券增加装备100HP  （100%成功）\r\n\r\n";

    //         textz += "#b#L8#" + 红色 + "使用10000点券增加装备500HP  （100%成功）\r\n\r\n";

    //         textz += "#b#L2#" + 红色 + "使用#v2022057#X1  增加装备500HP  （100%成功）\r\n\r\n";
    ...
    //             fstype = 2;
    //             cm.sendNext("你目前选择的是使用#v2022057#X1增加装备500HP（100%成功，不减回合）");
    ...
    //             fstype = 8;
    //             cm.sendNext("你目前选择的是用10000点券增加装备500HP（100%成功，不减回合））");
    ...
    //         } else if (fstype == 2) {
    //             if (!cm.haveItem(2022057, 1)) {
    //                 cm.sendOk("请带来#r 1 #k个#z2022057##v2022057#");
    //                 cm.dispose();
    //             } else {
    //                 var item = cm.getChar().getInventory(Packages.client.inventory.MapleInventoryType.EQUIP).getItem(1).copy();
    //                 var statup = new java.util.ArrayList();
