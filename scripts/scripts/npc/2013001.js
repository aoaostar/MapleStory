function action(mode, type, selection) {
    ...
    return;
     ...
     if (em.getProperty("pre").equals("0")) {
		if(cm.getPlayer().haveItem(4001063, 5) && cm.getPlayer().getMapId() == 920010000) {
			cm.给组队经验(168000);
			cm.gainItem(4001063, -5);
			em.setProperty("pre", "1");
		} else{
			cm.sendNext("我被远古精灵困在这座塔，快收集5片云朵让我出去。");
			cm.dispose();
			return;
		}
    }
    ...
    case 920010200: //walkway
        if (!cm.haveItem(4001050,20)) {
		cm.sendOk("我需要#b#t4001050# 20个#k，目前有#c4001050#个。");
		cm.dispose();
        } else {
    ...
    case 920010300: //storage
        if (!cm.haveItem(4001051,10)) {
        cm.sendOk("我需要#b#t4001051# 10个#k，目前有#c4001051#个。");
		cm.dispose();
        } else {
    ...
    case 920010400: //lobby
        if (em.getProperty("stage3").equals("1")) {
        cm.sendOk("请找到今天的唱片，并把它放入音乐盒拨放\r\n#v4001056#星期日\r\n#v4001057#星期一\r\n#v4001058#星期二\r\n#v4001059#星期三\r\n#v4001060#星期四\r\n#v4001061#星期五\r\n#v4001062#星期六\r\n");
        } else if (em.getProperty("stage3").equals("0")) {
    ...
    case 920010600: //lounge
		...
		cm.sendOk("我需要#b#t4001052# 20个#k，目前有#c4001052#个。");
		cm.dispose();
        } else {
    ...
    case 920010700: //on the way up
        ...
        if (total != 2) {
            ...
            if (cm.canHold(4001049,1)) {
                ...
                cm.gainItem(4001049,1); //sixth
                cm.给组队经验(240000);
				//cm.给组队物品(4310030, 1);//运动币4031456
				//cm.给组队物品(4031456, 2);//枫叶珠
				//cm.给组队物品(4001158, 1);//羽毛
                    em.setProperty("stage6", "1");
            } else {
                cm.sendOk("请清出一些空间。");
				cm.dispose();
