var weapon = [1004492, 1052929, 1082647, 1132287, 1102828, 1073057,1122306];
var req = [
    [4001126, 1000],
    [4000000, 500],
    [4000016, 500],
...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        cm.sendSimple("#b#e您好，制作#r寻宝套装#b需要以下材料，没有材料可不行哦\r\n\r\n" + msg + "");
    } else if (status == 1) {
        sels = selection;
        ...
        cm.sendYesNo("#b是否要兑换#r紫金枫叶系列#r #i" + weapon[sels] + "#? \r\n");
    } else if (status == 2) {
        for (var i = 0; i < req.length; i++) {
