...
//             text = "#r【中国心强化】点装属性提升说明：#d每次提升随机增加属性0-6点， 提升需要#v4000464#中国心一个！\r\n#b【规则】无限次数，必须是点装，100%成功率！#k\r\n";
...
//             switch (selstatus) {
//                 case 0:
// 				if (cm.getBossLog('PlayQuest100') >= 99999) {
// 			cm.sendOk("你今天强化次数超过99999次!");
// 			cm.dispose();
// 			} else {
...
// 								cm.喇叭(3, "『吃货强化』 ：恭喜【"+cm.getName()+"】使用中国心成功强化了点装，继续加油将它打造到极致吧！");
