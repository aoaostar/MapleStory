...
function start(mode, type, selection) {
    ...
    if (status == 0) {
        qm.askAcceptDecline("真是的！ 好像还有几个孩子留在森林内！ 我们不可能丢下孩子们逃走。 战神... 请你去救救那些孩子吧！ 我知道对受的您说这些话真的很厚颜无耻， 可是... 只能拜托您了！");
    } else if (status == 1) {
        ...
        qm.sendNextPrev("最重要的是不要惊慌。 战神。诺您想要确认任务进行情况，请按下 #bQ按键#k 确认任务栏位。");
    } else if (status == 2) {
        qm.sendNextPrev("拜托您了！战神！请救救那些孩子！我不希望有人再牺牲于黑魔法师的魔掌之下。");
    } else if (status == 3) {
